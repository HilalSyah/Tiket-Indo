...
export const Page9 = () => {
  ...
  const dataTiket = [
    {
      img: "Assets/Image/GambarWeb/kapal.png",
      tujuan: "Jawa-Bali",
      logoTiket: "Assets/Icons/peln.png",
      harga: "279,990",
      jenisPesawat: "Pelni",
      href:"Kapal_Tiket2"
    },
      ...
      <div className="foto flex justify-center items-center ms-10 gap-[5rem] relative z-10 ">
        {dataTiket.map((d) => (
          <div className="foto shadow-md w-[210px] h-[290px] rounded-xl mt-14 relative z-10 bg-[#9DB2BF]">
            <img src={d.img} alt="" className="w-full h-[131px] rounded-t-lg" />
