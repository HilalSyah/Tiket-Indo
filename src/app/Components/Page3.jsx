...
export const Page3 = () => {
  return (
    <div className="pages3 bg-[#D5DEE4] min-h-screen flex items-center justify-center flex-col">
      ...
      <div className="image-wisata flex me-[7rem] mt-[3rem] ">
        ...
        <div className="image2 flex flex-col me-[5rem]">
          <div className="img1">
            ...
            <p className="relative font-lexend font-black text-3xl text-white mt-[10rem] ms-5">Danau Toba</p>
          </div>
          <div className="img2 mt-[3rem]">
            ...
            <p className="relative font-lexend font-black text-3xl text-white mt-[10rem] ms-5">Raja Ampat</p>
          </div>
        </div>
        <div className="image1 justify-end items-end ms-[9.5rem]">
          ...
          <p className="relative font-lexend font-black text-3xl mt-[23rem] ms-6 text-white">Pulau Komodo</p>
        </div>
      </div>
